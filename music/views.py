...
def album_detail(request, album_id):
    ...
    my_album_detail = AlbumDetail(album)
    return render(request, 'music/album_detail.html', {'album': my_album_detail})
...
#     track_summary_list = [TrackSummary(track) for track in track_list]
#     # TODO: link html file
#     return render(request, 'music/index.html', {'track_list': track_summary_list})
#
#
# def all_artists(request):
#     artist_list = Artist.objects.order_by('-name')[:TOP_NUMBER]
#     artist_summary_list = [ArtistSummary(artist) for artist in artist_list]
#     # TODO: link html file
#     return render(request, 'music/index.html', {'artist_list': artist_summary_list})
